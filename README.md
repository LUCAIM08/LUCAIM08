...
- 🗨️ Discord: `lucaim08_`
- 🛠️ Tools I use: Visual Studio Code (yes, i use custom themes), Visual Studio, Kali Linux, Git
- 💬 Languages: Italian (Native), English (Fluent), Spanish (Conversational), German (Basic), Russian (Basic)
